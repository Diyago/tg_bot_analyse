...
class CommunicationAnalyzer:
    ...
    def _get_system_prompt(self) -> str:
        ...
        return (
            ...
            "- 1–2: хаотично, токсично, срывы договорённостей.\n"
            "- 3–4: много шума и недопониманий, мало результата.\n"
            "- 5: нейтрально, баланс плюсов и минусов без перевеса.\n"
            "- 6: в целом работает, но заметные пробелы мешают эффективности.\n"
            "- 7: устойчиво неплохо, редкие сбои, в основном эффективно.\n"
            "- 8–9: высокая ясность, быстрые договорённости, конструктивная ОС.\n"
            "- 10: эталонно: чётко, быстро, бережно, улучшения закрепляются системно.\n\n"
...
✅ **Позитивные паттерны:**"""
    ...
    def _get_personal_analysis_system_prompt(self) -> str:
        ...
        return (
            ...
            "- 1–2: деструктивные паттерны, системные сбои.\n"
            "- 3–4: много несогласованности, низкая ясность.\n"
            "- 5: смешанная картина без явного перевеса.\n"
            "- 6: лёгкий перевес в пользу эффективности, заметные недочёты.\n"
            "- 7: стабильно хорошо, отдельные огрехи.\n"
            "- 8–9: образцово, быстро, ясно, бережно.\n"
            "- 10: выдающийся уровень, редкий эталон.\n\n"
